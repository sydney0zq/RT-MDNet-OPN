...
opts['model_path'] = './snapshots/rt_mdnet_fclayers.pth'
#opts['model_path'] = './snapshots/rt_mdnet_fclayers_100cycle_2kvideo_77.6.pth'

#opts['img_size'] = 107
opts['img_size'] = (864, 480)
opts['mean_value'] = [102.9801, 115.9465, 122.7717]
...
opts['lr_init'] = 0.001 # original = 0.0001
